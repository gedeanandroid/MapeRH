...
import { Mail, Lock, Check, ArrowLeft, Building2, Users, TrendingUp, User } from 'lucide-react';
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-neutral-gray900 mb-3">
              {isLogin ? 'Bem-vindo de volta' : 'Crie sua conta de consultor'}
            </h1>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              {!isLogin && (
                ...
                >
                  <div className="space-y-2 pb-4">
                    <label htmlFor="name" className="block text-sm font-medium text-neutral-gray800">
                      Nome completo
                    </label>
              ...
              {!isLogin && (
                ...
                >
                  <div className="space-y-2 pt-4">
                    <label htmlFor="confirm-password" className="block text-sm font-medium text-neutral-gray800">
                      Confirmar senha
                    </label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary-main transition-colors">
            ...
            <div className="pt-2">
              <Button variant="primary" className="w-full !py-4 text-lg shadow-lg shadow-secondary-main/20 hover:shadow-xl hover:shadow-secondary-main/30" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-neutral-gray600">
              ...
              <button onClick={toggleMode} className="font-semibold text-primary-main hover:text-primary-dark transition-colors hover:underline">
